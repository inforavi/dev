    ...
    <div id="hero" class="rev_slider gradient_slider" style="display:none">
        <ul>
            ...
            <li data-index="rs-214" 
                ...
                data-description="">
                <!-- IMAGE -->
                <img src="img/slider/hero.jpg" alt="Image" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                <!-- LAYER NR. 1 --> 
